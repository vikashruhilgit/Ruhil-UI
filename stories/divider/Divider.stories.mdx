...
<Meta title="Firstech UI/Component/Divider/Doc" />
...
<Canvas withToolbar>
  <Story id="firstech-ui-component-divider--divider" height="50px" />
</Canvas>
...
<Canvas withToolbar>
  <Story id="firstech-ui-component-divider--vertical" height="50px" />
</Canvas>
