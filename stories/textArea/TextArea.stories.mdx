...
```html
<ru-textarea label="My Textarea"></ft-textarea>
```
...
```html
<ru-textarea label="My Textarea" helper="Helper Text"></ft-textarea>
```
...
<ru-textarea label="My Textarea" required> </ft-textarea>
```
...
```html
<ru-textarea outlined label="My Textarea"> </ft-textarea>
```
...
<ru-textarea class="rounded" label="My Textarea" outlined> </ft-textarea>
```
