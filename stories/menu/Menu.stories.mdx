...
<Meta title="Ruhil UI/Component/Menu/Doc" />
...
<div style="position:relative;">
  <ru-button id="button" raised label="Open Menu"></ft-button>

  <ru-menu multi id="menu">
    <ru-list-item group="a" graphic="icon">
      <ru-icon slot="graphic">check</ft-icon>
      <span>Item 0</span>
    </ft-list-item>
...
<div style="position: relative;">
  <ru-button id="button" raised label="Open Menu"></ft-button>
  <ru-menu activatable multi id="menu">
    <ru-list-item selected activated>Item 0</ft-list-item>
    <ru-list-item selected activated>Item 1</ft-list-item>
    <ru-list-item>Item 2</ft-list-item>
    <ru-list-item>Item 3</ft-list-item>
  </ft-menu>
