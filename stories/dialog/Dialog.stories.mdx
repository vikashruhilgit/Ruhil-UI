...
<ru-dialog open>
  ...
  <ru-button slot="primaryAction" dialogAction="discard"> Discard </ft-button>
  <ru-button slot="secondaryAction" dialogAction="cancel"> Cancel </ft-button>
</ft-dialog>
```
...
<ru-dialog heading="Phone Ringtone" open>
  <div>
    <ru-formfield label="Never Gonna Give You Up">
      <ru-radio id="a1" name="a" checked></ft-radio>
    </ft-formfield>
    <ru-formfield label="Hot Cross Buns">
      <ru-radio name="a"></ft-radio>
    </ft-formfield>
    <ru-formfield label="None">
      <ru-radio name="a"></ft-radio>
    </ft-formfield>
  </div>
  <ru-button dialogAction="ok" slot="primaryAction"> ok </ft-button>
  <ru-button dialogAction="cancel" slot="secondaryAction"> cancel </ft-button>
</ft-dialog>
```
...
<ru-dialog heading="Styled" class="styled" open>
  <div>
...
```html
<ru-dialog heading="Stacked" stacked>
  <div>
    This is what happens when you set the stacked property on ft-dialog. Notice
    that the primary action is now on top.
  </div>
  <ru-button slot="primaryAction" dialogAction="close"> Primary </ft-button>
  <ru-button slot="secondaryAction" dialogAction="close"> Secondary </ft-button>
</ft-dialog>
```
...
```html
<ru-dialog scrimClickAction="">
  <div>
    This will prevent a click outside of the dialog from closing the dialog.
  </div>
  <ru-button slot="primaryAction" dialogAction="close"> Discard </ft-button>
  <ru-button slot="secondaryAction" dialogAction="close"> Cancel </ft-button>
</ft-dialog>
```
...
<ru-dialog open>
  ...
  <ru-button slot="primaryAction" dialogAction="ok">ok</ft-button>
  <ru-button slot="secondaryAction">cancel</ft-button>
</ft-dialog>
```
