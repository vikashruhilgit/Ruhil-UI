...
<Meta title="Ruhil UI/Form Component/Text Field/Doc" />

<style>{`

`}</style>

# Text Field `<ru-textfield>`
...
<Canvas withToolbar>
  <Story
    id="ruhil-ui-form-component-text-field--standard-and-filled"
    height="100px"
  />
</Canvas>

```html
<ru-textfield label="My Textfield"></ft-textfield>
```

### Icon - Leading

<Canvas withToolbar>
  <Story id="ruhil-ui-form-component-text-field--icon-leading" height="100px" />
</Canvas>

```html
<ru-textfield label="My Textfield" icon="event"></ft-textfield>
```
...
<Canvas withToolbar>
  <Story
    id="ruhil-ui-form-component-text-field--icon-trailing"
    height="100px"
  />
</Canvas>

```html
<ru-textfield label="My Textfield" iconTrailing="delete"></ft-textfield>
```

### Helper Text

<Canvas withToolbar>
  <Story id="ruhil-ui-form-component-text-field--helper-text" height="100px" />
</Canvas>

```html
<ru-textfield label="My Textfield" helper="Helper Text"></ft-textfield>
```
...
<Canvas withToolbar>
  <Story
    id="ruhil-ui-form-component-text-field--primary-color"
    height="100px"
  />
</Canvas>
...
<Canvas withToolbar>
  <Story
    id="ruhil-ui-form-component-text-field--variants-outlined"
    height="100px"
  />
</Canvas>

```html
<ru-textfield outlined label="My Textfield" iconTrailing="delete">
</ft-textfield>
```
...
<Canvas withToolbar>
  <Story
    id="ruhil-ui-form-component-text-field--variant-shaped"
    height="100px"
  />
</Canvas>
...
<ru-textfield class="rounded" label="My Textfield" outlined> </ft-textfield>
```
